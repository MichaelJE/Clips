...
Keywords::Keywords()
{
    ...
    type = "COOL Message Handler Commands";
    ...
    type = "Generic Function Commands";
    ...
    type = "COOL Instance Slot Functions";
    ...
    type = "COOL Instance Predicate Functions";
    ...
    //keywords.insert(type, "type"); // Constraint Attributes
    ...
    type = "Sequence Expansion Functions";
    ...
    //keywords.insert(type, "?VARIABLE"); // var
    ...
    //keywords.insert(type, "?DERIVE");
    //keywords.insert(type, "?NONE");

    type = "COOL Defclass Roles";
